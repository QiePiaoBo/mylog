package com.mylog.platform.gateway.repositories;

import com.alibaba.fastjson.JSONArray;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.mylog.platform.gateway.models.Route;
import com.mylog.platform.gateway.service.IRouteService;
...
public class MysqlRouteDefinition implements RouteDefinitionRepository {
    ...
    public static URI getUri(String uriStr){
        String connectType = "http";
        URI uri;
        if(uriStr.startsWith(connectType)){
            //http地址
